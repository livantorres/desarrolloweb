...
$consulta = $conexion -> prepare("
		SELECT * FROM citas Inner Join clientes on citas.clientes_Id_clientes=clientes.Id_clientes
		inner join empleado on citas.empleado_Id_empleado = empleado.Id_empleado 
